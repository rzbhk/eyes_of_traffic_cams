...
if __name__ == "__main__":
    ...
    L = int(0.75 * len(df))
    # 3/4 of the length of data (over time) to be used as train and what ever comes after this would be for evaluation
    ...
    params = {"timesteps": 18, "lstm_units": 51, "bidirectional": True, "random_seed": 254, "input_N": 23,
              "lstm_recurrent_dropout": 0.07583119820567974, "dense_l2reg": 0.0003429217157848095, "batch_size": 1}
